  ...
  return (
    <section id="experience" className="section-space">
      <div className="section-shell">
        ...
        <StaggerGroup className="mt-16 grid gap-5 md:grid-cols-3" stagger={0.08}>
          {experience.highlights.map((item, index) => (
            <Motion.div key={item.label} variants={createStaggerItem(16, 0.42)}>
              ...
              >
                ...
                <p
                  className="mt-2 text-sm uppercase tracking-[0.24em] text-foreground-muted"
                >
                  {item.label}
                </p>
              </Motion.div>
        ...
        <div className="mt-16 grid gap-14 lg:grid-cols-[1.08fr_0.92fr]">
                ...
                <Reveal key={`${entry.title}-${entry.org}`} delay={index * 0.08}>
                  <article className="relative">
                    ...
                    <div className="surface-panel interactive-outline rounded-[1.95rem] p-6 sm:p-7">
                      ...
                      <p className="mt-6 max-w-[32rem] text-[0.99rem] leading-[1.9] text-foreground-muted">{entry.summary}</p>
          ...
          <Reveal delay={0.12}>
            <div className="space-y-6 lg:sticky lg:top-28">
              <Motion.div
                ...
                className="surface-panel-strong interactive-outline rounded-[2.1rem] p-6 sm:p-7"
              >
              ...
              <Motion.div
                whileHover={{ y: -6, scale: 1.015 }}
                transition={{ duration: 0.28, ease: MOTION_EASE }}
                className="surface-panel interactive-outline rounded-[2.1rem] p-6 sm:p-7"
              >
